...
wurl = "http://www.silosec.org/w"	# Wiki's URL
...
print G+'*'*80
print P+"                            You're using"
print ""
print ""

print "         d888888b d8b   db d88888b  .d88b.  .d8888. d88888b  .o88b. "
print "           `88'   888o  88 88'     .8P  Y8. 88'  YP 88'     d8P  Y8 "
print "            88    88V8o 88 88ooo   88    88 `8bo.   88ooooo 8P      "
print "            88    88 V8o88 88~~~   88    88   `Y8b. 88~~~~~ 8b      "
print "           .88.   88  V888 88      `8b  d8' db   8D 88.     Y8b  d8 "
print "         Y888888P VP   V8P YP       `Y88P'  `8888Y' Y88888P  `Y88P' "
print ""
print "               ______ _           _                       _      "
print "              |  ____| |         | |                     | |     "
print "              | |__  | | __ _ ___| |__   ___ __ _ _ __ __| |___  "
print "              |  __| | |/ _` / __| '_ \ / __/ _` | '__/ _` / __| "
print "              | |    | | (_| \__ \ | | | (_| (_| | | | (_| \__ \ "
print "              |_|    |_|\__,_|___/_| |_|\___\__,_|_|  \__,_|___/ "
                                                        

print ""
print ""
print P+"                       A Silo Collective project"
print ""
print P+"                   Please login to the Quizlet API key: "
print ""
print ""

# Fetch credentials from the user - 
user = raw_input(G+"Enter Account Username: ")
pwd = getpass.getpass(G+"Enter Account password: ")
